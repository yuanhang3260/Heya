...
<div class="card home-profile-detail-container">
  ...
  <div v-if="live" class="user-profile-item">    
    ...
    <p class="user-profile-detail">
      <span>Lives in</span>
      <a v-bind:href="googleMapURL(live.name)" class="user-profile-link" target="_blank">{{live.name}}</a>
    </p>
  </div>
  ...
  <div v-if="hometown" class="user-profile-item">
    ...
    <p class="user-profile-detail">
      <span>From</span>
      <a v-bind:href="googleMapURL(hometown.name)" class="user-profile-link" target="_blank">{{hometown.name}}</a>
    </p>
  </div>
</div>
